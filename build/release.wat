(module
 ...
 (data $30 (i32.const 5708) "\1c")
 (data $30.1 (i32.const 5720) "\1a\00\00\00\08\00\00\00\01")
 (data $31 (i32.const 5740) "\1c")
 (data $31.1 (i32.const 5752) "\1b\00\00\00\08\00\00\00\02")
 (data $32 (i32.const 5772) "\1c")
 (data $32.1 (i32.const 5784) "\1c\00\00\00\08\00\00\00\03")
 (data $33 (i32.const 5804) "<")
 (data $33.1 (i32.const 5816) "\02\00\00\00$\00\00\00~\00l\00i\00b\00/\00t\00y\00p\00e\00d\00a\00r\00r\00a\00y\00.\00t\00s")
 (data $34 (i32.const 5868) "|")
   ...
   if
    ...
    if (result i32)
     ...
     block $__inlined_func$~lib/string/String.__eq$744 (result i32)
      ...
      block $__inlined_func$~lib/util/string/compareImpl$226
       loop $while-continue|1
        local.get $0
        local.tee $4
        i32.const 1
        ...
        if
         ...
         local.get $8
         i32.ne
         br_if $__inlined_func$~lib/util/string/compareImpl$226
         local.get $2
         i32.const 2
         i32.add
         local.set $2
  ...
  if (result i32)
   ...
   if (result i32)
    ...
    block $__inlined_func$~lib/metashrew-as/assembly/utils/yabsp/Script#is_witness_program$21 (result i32)
     ...
     local.set $4
     i32.const 0
     block $__inlined_func$~lib/metashrew-as/assembly/utils/yabsp/valid_witness_version_from_opcode$375 (result i32)
      i32.const 1
      local.get $1
      i32.load8_u
      local.tee $1
      ...
      i32.ge_u
      i32.or
      br_if $__inlined_func$~lib/metashrew-as/assembly/utils/yabsp/valid_witness_version_from_opcode$375
      drop
      i32.const 1
      local.get $1
      i32.eqz
